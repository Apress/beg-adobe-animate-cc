...
// stage content:
(lib.slideshow = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(382,21,1,1,0,0,0,50,11);
...
p.nominalBounds = new cjs.Rectangle(168.5,250.5,424,466.6);
// library properties:
lib.properties = {
	width: 320,
	height: 485,
	...
	opacity: 1.00,
	manifest: [
		{src:"https://code.jquery.com/jquery-2.2.4.min.js?1479666996879", id:"lib/jquery-2.2.4.min.js"},
		{src:"components/sdk/anwidget.js?1479666996879", id:"sdk/anwidget.js"},
		{src:"components/ui/src/label.js?1479666996879", id:"an.Label"},
		{src:"components/ui/src/image.js?1479666996879", id:"an.Image"},
		{src:"components/ui/src/css.js?1479666996879", id:"an.CSS"},
		{src:"components/ui/src/combobox.js?1479666996879", id:"an.ComboBox"},
		{src:"components/ui/src/button.js?1479666996879", id:"an.Button"}
	],
	preloads: []
};
